...
class Master_model extends CI_Model
{
    ...
    {
        $this->datatables->select('id,dari, ke, semester,tahun,status');
        $this->datatables->from('semester');
        $this->datatables->add_column('bulk_select', '<div class="text-center"><input type="checkbox" class="check" name="checked[]" value="$1"/></div>', 'id,dari, ke, semester, tahun,status');
        return $this->datatables->generate();
    }
